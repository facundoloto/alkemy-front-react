          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="me-auto">
              ...
              <Link to={"/record/"} className="nav-link text-white">
                <span className="ms-2">Create Record</span>
              </Link>
            </Nav>
            <button className="btn btn-egress" onClick={logout}>
              {" "}
              <img src={img_logout} alt="Bootstrap" width="30" height="30" />
        ...
        <ul className="nav nav-pills flex-column mb-auto">
          ...
          <li className="nav-item">
            <Link to={"/record/"} className="nav-link text-white">
              ...
              <span className="ms-2"></span>Create Record
            </Link>
          </li>
        </ul>
        <button className="btn btn-egress" onClick={logout}>
